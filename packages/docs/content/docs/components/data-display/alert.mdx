...
<ComponentPreview
  description="Alerts with interactive elements like dismiss buttons and action buttons"
  code={`"use client";
...
<ComponentPreview
  description="Status alerts with badges showing different operational states and notifications"
  code={`import { Alert, AlertDescription, AlertTitle } from "@helgadigitals/vera-ui";
...
<ComponentPreview
  description="Form validation examples showing error and success states with alert feedback"
  code={`import { Alert, AlertDescription, AlertTitle } from "@helgadigitals/vera-ui";
...
<ComponentPreview
  description="System announcements with interactive buttons for feature updates, security notices, and maintenance alerts"
  code={`import { Alert, AlertDescription, AlertTitle } from "@helgadigitals/vera-ui";
import { Button } from "@helgadigitals/vera-ui";
import { 
  Megaphone, 
