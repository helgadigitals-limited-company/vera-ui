---
title: Card
description: A versatile container component for grouping related content and actions. Cards provide a structured way to display information with clear boundaries and hierarchy.
