...
<ComponentPreview
  description="Basic avatar examples with images and automatic fallbacks"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
...
<ComponentPreview
  description="Avatar with image source and automatic fallback handling"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
...
export function AvatarWithImage() {
  return (
    <div className="flex space-x-4">
      <Avatar>
        <AvatarImage 
          src="https://ui.shadcn.com/avatars/shadcn.png" 
          alt="User avatar"
        />
...
<ComponentPreview
  description="Avatar components in different sizes from small to large"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
...
<ComponentPreview
  description="Avatar fallback behaviors including broken images, custom icons, and styling"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
import { User } from "lucide-react";
...
export function AvatarFallbackExample() {
  return (
    <div className="flex space-x-4">
      ...
      <Avatar>
        <AvatarImage src="https://api.dicebear.com/7.x/avataaars/svg?seed=Success" alt="@user" />
        <AvatarFallback>JD</AvatarFallback>
      </Avatar>
      
      {/* Invalid image URL - shows fallback */}
      <Avatar>
        <AvatarImage src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg'/%3E" alt="Invalid" />
...
<ComponentPreview
  description="User list displaying avatars with status indicators, fallback behavior, and role badges"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
...
<ComponentPreview
  description="Grouped avatars in overlapping and spaced layouts, perfect for team displays"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
...
<ComponentPreview
  description="Complete profile header layout with avatar, user information, action buttons, and skill badges"
  code={`import { Avatar, AvatarFallback, AvatarImage } from "@helgadigitals/vera-ui";
