...
```tsx
import { Textarea } from "@helgadigitals/vera-ui"
  ...
  return (
    <div className="space-y-2">
      ...
      <Textarea
        ...
        maxLength={maxLength}
        className={value.length >= maxLength ? "border-yellow-500" : ""}
      />
  ...
  return (
    <div className="border rounded-lg p-4 space-y-3">
      <Textarea
        ...
        className="border-0 shadow-none resize-none focus-visible:ring-0 p-0"
        rows={3}
      />
