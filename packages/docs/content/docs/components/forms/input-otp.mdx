...
export default function PatternValidationExample() {
  const [value, setValue] = useState("")
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        <label className="text-sm font-medium">
          Enter numeric code (digits only)
        </label>
        <InputOTP
          maxLength={4}
      ...
      <div className="text-center text-sm">
        {value.length === 4 ? (
          <span className="text-green-600">✓ Code complete</span>
        ) : (
          <span className="text-muted-foreground">
            {4 - value.length} digits remaining
          </span>
        )}
      </div>
    </div>
...
export default function DifferentLengthsExample() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* 8-digit code */}
      <div className="space-y-2">
        <label className="text-sm font-medium">8-digit backup code</label>
        <InputOTP
          maxLength={8}
          value={value8}
