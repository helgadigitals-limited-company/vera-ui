...
import { 
  ...
  ModalPopoverExample, 
  LargeDatasetExample 
} from "@/components/form-components-examples/multi-select-examples"
...
<ComponentPreview
  description="Basic multi-select with framework options"
...
<ComponentPreview
  description="Multi-select with fruit options and value display"
  code={`import { useState } from "react"
import { MultiSelect } from "@helgadigitals/vera-ui"
...
<ComponentPreview
  description="Multi-select with icon-enhanced options"
  code={`import { useState } from "react"
...
<ComponentPreview
  description="Multi-select with different visual variants"
  code={`import { useState } from "react"
import { MultiSelect } from "@helgadigitals/vera-ui"
...
<ComponentPreview
  description="Multi-select with badge animation effects"
  code={`import { useState } from "react"
import { MultiSelect } from "@helgadigitals/vera-ui"
...
<ComponentPreview
  description="Multi-select with different maxCount settings"
  code={`import { useState } from "react"
import { MultiSelect } from "@helgadigitals/vera-ui"
...
<ComponentPreview
  description="Multi-select integrated with React Hook Form including validation"
...
<ComponentPreview
  description="Multi-select with modal popover that blocks interaction with other elements"
  code={`import { useState } from "react"
import { MultiSelect } from "@helgadigitals/vera-ui"
...
<ComponentPreview
  description="Multi-select handling large datasets with search functionality"
  code={`import { useState } from "react"
import { MultiSelect } from "@helgadigitals/vera-ui"
